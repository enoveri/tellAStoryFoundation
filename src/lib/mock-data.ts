...
export const stories: Story[] = [
  {
    ...
    comments: [
        ...
        replies: [
          {
            id: "r1",
            userId: "u2",
            content: "Yes, I can share our starter list soon.",
            createdAt: "48m ago",
          },
        ],
      },
      {
        ...
        userId: "u6",
        content:
          "A library born from a story circle — this is exactly what Tell A Story is about.",
        createdAt: "30m ago",
        replies: [],
      },
    ],
    ...
    comments: [
      {
        ...
        userId: "u4",
        content:
          "Thank you for sharing this. I'm thinking about attending my first workshop — you've made it feel less scary.",
        createdAt: "3h ago",
        replies: [
          {
            id: "r2",
            userId: "u3",
            content:
              "Please come. The first step is always the hardest and the most worth it.",
            createdAt: "2h ago",
          },
        ],
      },
    ...
    comments: [
      {
        ...
        userId: "u5",
        content:
          '"That shared grief was the beginning of my healing" — I will carry this sentence with me.',
        createdAt: "20h ago",
        replies: [],
      },
    ],
  },
  {
    ...
    excerpt:
      "I teach poetry to boys who have never read a poem about themselves.",
    ...
    comments: [
      {
        ...
        userId: "u2",
        content:
          "That teenager deserved to be found. Thank you for being the people who found her.",
        createdAt: "2d ago",
        replies: [],
      },
    ],
...
export const blogs: Blog[] = [
  {
    ...
    summary:
      "How personal narratives build trust, belonging, and practical change.",
    cover:
  ...
  },
  {
    ...
    summary:
      "A practical guide for anyone who wants to create safe storytelling spaces in their community.",
    cover:
...
export const events: Event[] = [
  {
    ...
    description:
      "Join our monthly gathering where members share personal stories in a safe, facilitated space.",
    date: "Mar 8, 2026",
    time: "10:00 AM",
  ...
  },
  {
    ...
    description:
      "A hands-on workshop exploring how writing your story can be a powerful tool for mental wellness.",
    date: "Mar 15, 2026",
    time: "2:00 PM",
  ...
  },
  {
    ...
    description:
      "An evening of stories, music, and celebration to raise funds for our next chapter of programmes.",
    date: "Apr 3, 2026",
    time: "6:30 PM",
...
export const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "Before Tell A Story I thought my life was too ordinary to matter. Now I know every ordinary life is extraordinary. My story was published and three strangers said it changed their week.",
    country: "Nigeria",
  },
  {
    id: "t2",
    ...
    quote:
      "I use the workshops with my youth group every month. The transformation in confidence and empathy among teenagers is something I could not have produced with any other tool.",
    country: "Ghana",
  },
  {
    id: "t3",
    ...
    quote:
      "Writing my story here was the first time I chose my own narrative. The comments from strangers who felt seen by my words healed something in me I didn't know was broken.",
    country: "Kenya",
  },
];
