    ...
    <div className="flex h-full flex-col justify-between p-5">
      <div>
        ...
        <p className="mt-2 text-sm leading-relaxed text-[color:var(--foreground)]/80">
          A safe community where people write their journeys, support each
          other, and amplify hope.
        </p>
      </div>
      <div className="mt-4 flex gap-2">
        <Link
          href="/feed"
          className="inline-flex items-center gap-1.5 rounded-full bg-[color:var(--primary)] px-4 py-2 text-sm font-semibold text-[color:var(--primary-fg)] shadow-sm hover:bg-[color:var(--primary-dark)]"
        >
...
function SlideGallery() {
  return (
    <div className="flex h-full flex-col p-5">
      <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-[color:var(--primary)]">
        Our Gallery
      </p>
      <h2 className="mb-3 text-lg font-bold text-[color:var(--foreground)]">
        Moments that matter
      </h2>
      ...
      <Link
        href="/blog"
        className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-[color:var(--primary)] hover:underline"
      >
...
function SlideStats() {
  return (
    <div className="flex h-full flex-col justify-center p-5">
      ...
      <h2 className="mb-4 text-lg font-bold text-[color:var(--foreground)]">
        Stories change lives — the numbers prove it
      </h2>
      ...
      <Link
        href="/about"
        className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-[color:var(--primary)] hover:underline"
      >
...
function SlideFounder() {
  return (
    <div className="flex h-full flex-col justify-between p-5">
      <div>
        <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-[color:var(--primary)]">
          From Our Founder
        </p>
        ...
        <p className="text-sm leading-relaxed text-[color:var(--foreground)]/90 italic">
          "I started Tell A Story Foundation because I believe every person
          carries a story worth hearing. When we listen to each other — truly
          listen — we begin to see our shared humanity. This platform is that
          listening space, built for you."
        </p>
      </div>
      <div className="mt-4 flex items-center gap-3">
        ...
        <Link
          href="/about"
          className="ml-auto inline-flex items-center gap-1 rounded-full bg-[color:var(--primary-light)] px-3 py-1.5 text-xs font-semibold text-[color:var(--primary)] hover:bg-[color:var(--primary-mid)]"
        >
          ...
          <button
            ...
            className={cn(
              ...
              i === active
                ...
                : "w-1.5 bg-[color:var(--primary-light)]",
            )}
          />
        ))}
      </div>
