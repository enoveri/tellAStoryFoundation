...
export default function EventsPage() {
  const upcoming = events.filter(() => true); // all events; filter by date once real data exists
  ...
  return (
    <MobileShell title="Events" subtitle="Workshops, circles & more">
      <div className="space-y-4 px-4">
        ...
        >
          <p className="text-xs font-bold uppercase tracking-widest" style={{ color: "var(--primary-mid)" }}>
            Join us
          </p>
          <h2 className="mt-1 text-xl font-bold" style={{ color: "var(--inverse-fg)" }}>
            Upcoming Events
          </h2>
        ...
        {upcoming.map((event) => (
          ...
          >
            ...
            <div className="relative h-40 w-full">
              ...
              />
              <span className={cn("absolute left-3 top-3 rounded-full px-2.5 py-0.5 text-[10px] font-bold capitalize", typeColors[event.type])}>
                {event.type}
              </span>
            </div>
            ...
            <div className="space-y-2 p-4">
              ...
              <div className="space-y-1 pt-1">
                <div className="flex items-center gap-1.5 text-xs" style={{ color: "var(--muted)" }}>
                  ...
                  <Clock size={12} className="ml-2" style={{ color: "var(--primary)" }} />
        ...
        >
          <p className="text-sm font-semibold" style={{ color: "var(--foreground)" }}>Want to host an event?</p>
